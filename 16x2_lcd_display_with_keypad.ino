...
/*Demonstrates the use a 16x2 LCD display and 4x4 LCD display.
   ...
   * LCD V0, GND, RW, LED-K pin to pin GND
   ...
   * COLUMN1  pin to digital pin 9
   * COLUMN2  pin to digital pin 8
   * COLUMN3  pin to digital pin 7
   * COLUMN4  pin to digital pin 6
   */
